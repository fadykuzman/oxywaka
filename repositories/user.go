...
func (r *GormUserRepository) GetByIds(userIds []string) ([]*models.User, error) {
...
func (r *GormUserRepository) GetMany(ids []string) ([]*models.User, error) {
	var users []*models.User
	if err := r.db.
		Table("users").
		Where("id in ?", ids).
...
func (r *GormUserRepository) GetAllByReports(reportsEnabled bool) ([]*models.User, error) {
	var users []*models.User
...
func (r *GormUserRepository) GetAllByLeaderboard(leaderboardEnabled bool) ([]*models.User, error) {
	var users []*models.User
...
func (r *GormUserRepository) GetByLoggedInAfter(t time.Time) ([]*models.User, error) {
	return r.getByLoggedIn(t, true)
}

func (r *GormUserRepository) GetByLoggedInBefore(t time.Time) ([]*models.User, error) {
...
func (r *GormUserRepository) GetByLastActiveAfter(t time.Time) ([]*models.User, error) {
...
func (r *GormUserRepository) UpdateField(user *models.User, key string, value interface{}) (*models.User, error) {
	if err := r.ensureUniqueEmail(user); err != nil {
		return nil, err
	}
...
func (r *GormUserRepository) DeleteTx(user *models.User, tx *gorm.DB) error {
	return tx.Delete(user).Error
}

func (r *GormUserRepository) getByLoggedIn(t time.Time, after bool) ([]*models.User, error) {
	var users []*models.User
...
func (r *GormUserRepository) ensureUniqueEmail(user *models.User) error {
